        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              >
                <button className="nav-link text-white hover:text-gold font-light tracking-wide">
                  Gallery
                </button>
                {showDropdown && galleries && (
                  <div className="absolute top-full left-0 mt-0 bg-black bg-opacity-90 backdrop-blur-md rounded-lg p-4 min-w-[200px] opacity-100 visible transform translate-y-0 transition-all duration-300">
